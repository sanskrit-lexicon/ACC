...
ACC entries use standard CDSL Sanskrit-lexicography markup. See [DATA_DICTIONARY.md](https://github.com/sanskrit-lexicon/ACC/blob/main/DATA_DICTIONARY.md) for the full tag reference.
...
Annotated example — the first entry of `acc.txt`:
