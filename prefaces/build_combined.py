...
CODE = os.environ.get('DICT', 'acc')
# ACC front matter source language is English → base .md IS the English edition.
LANGS = {
  'en': ('.md',    f'{CODE}pref_all.en.md', 'Front matter — English',                          'Page',     'Source (scan)'),
  'ru': ('.ru.md', f'{CODE}pref_all.ru.md', 'Предварительные материалы — русский',              'Страница', 'Источник (скан)'),
}
def split(text):
