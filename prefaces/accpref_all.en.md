...
- [Page 01 — Front Matter (vol. 1)](#page-01-front-matter-vol-1)

---

## Page 01 — Front Matter (vol. 1)

<sub>Source (scan): [(html text layer; no per-page PNG for acc)](https://sanskrit-lexicon.uni-koeln.de/scans/csldev/csldoc/build/dictionaries/prefaces/accpref.html#front-matter)</sub>
